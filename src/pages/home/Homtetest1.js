...
//         <Typography variant="h4" component="h2" gutterBottom align="center" className="form-title" style={{ fontSize: "44px" }}>
...
//           {/* Essential Dates */}
//           <Box className="form-section glass-surface">
//             <Typography variant="h6" className="section-title">Essential Dates</Typography>
//             <Grid container spacing={3}>
//               <Grid item xs={12} sm={4}>
//                 <TextField
//                   fullWidth
...
//               </Button>
//             </Box>
//             <Button variant="contained" type="submit" className="submit-button glass-button" style={{ marginLeft: '20px' }}>
//               Save & Continue
//             </Button>
//             <Button variant="contained" className="glass-button" style={{ marginLeft: '20px' }}>
//               Cancel
//             </Button>
//           </Box>
//         </form>
